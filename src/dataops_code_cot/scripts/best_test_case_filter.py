...
# Allow relative import when called from outside the scripts directory
...
def process_file(input_file, output_file):
    ...
    # Use regular apply — pandarallel conflicts with subprocess/joblib contexts
    df_out = df.apply(select_best, axis=1)
